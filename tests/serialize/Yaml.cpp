...
TEST_CASE("YamlSerializer")
{
    SUBCASE("deserialize - simple document")
    {
        Node n;
...
workers:
  ...
  - name: cleanup
    ...
    SUBCASE("deserialize - root is a scalar")
    {
        Node n = "hello";
        auto serialized = serialize(n, Format::YAML);
        REQUIRE(serialized == "---\nhello\n");
    ...
    SUBCASE("deserialize - root is a flat list of scalars")
    {
        Node n;
        n.push_back(1);
        n.push_back(2);
...
- 3
    ...
    SUBCASE("deserialize - root is a flat map")
    {
        Node n;
        n["a"] = 1;
        n["b"] = 2;
...
b: 2
    ...
    SUBCASE("deserialize - map with a null value")
    {
        Node n;
        n["a"] = 1;
        n["b"];     // null
...
c: 3
    ...
    SUBCASE("deserialize - list of lists")
    {
        Node n;
        n[0].push_back(1);
        n[0].push_back(2);
...
- - 3
  - 4
    ...
    SUBCASE("deserialize - list containing a mix of scalars and maps")
    {
        Node n;
        n[0] = "plain";
        n[1]["key"] = "value";
...
- key: value
    ...
    SUBCASE("deserialize - deeply nested single-key chain")
    {
        Node n;
        n["a"]["b"]["c"]["d"] = "leaf";
...
a:
  b:
    ...
    SUBCASE("deserialize - list of maps, each containing a nested list")
    {
        Node n;
        n[0]["name"] = "a";
